...
public class EventController {
    ...
    public List getByMonth(@RequestParam(name = "date1") String date1, @RequestParam(name = "date2") String date2){
        ...
        return eventService.castTypeToDto(eventRepository.findAllByEventStartTimeLessThanEqualAndEventStartTimeGreaterThanEqual(instant2,instant, Sort.by(Sort.Direction.DESC, "eventStartTime")));
    }
