...
insert into event values(3, "Jirachoti Aekopas", "teststudent2@mail.kmutt.ac.th", "2022-12-23 17:00:00", 30, "late", 3 , null);
...
insert into event values(6, "Daranpob Posamran", "teststudent@mail.kmutt.ac.th", "2022-12-23 17:00:00", 30, "", 1 , null);
...
insert into event values(9, "Daranpob Posamran", "teststudent@mail.kmutt.ac.th", "2022-12-23 16:00:00", 30, "no record", 2 , null);
...
insert into event values(12, "Jirachoti Aekopas", "teststudent2@mail.kmutt.ac.th", "2022-12-02 10:00:00", 30, "no record", 3 , null);
...
insert into event values(15, "Daranpob Posamran", "teststudent@mail.kmutt.ac.th", "2022-12-05 17:00:00", 30, "", 3 , null);
...
-- password: teststudent
insert into user(userId,name, email, role, password) values(11, "Prayuth Krajang", "teststudent@mail.kmutt.ac.th", "student", "$argon2id$v=19$m=65536,t=22,p=1$8UwRcOQL4cDywElx+MYzVw$rPSwObuPmgD/j2+YFYiINg");

-- password: IP21student
insert into user(userId,name, email, role, password) values(12, "INT491 User003", "int491.user003@mail.kmutt.ac.th", "student", "$argon2id$v=19$m=65536,t=22,p=1$xuAYyYVpZkEFQ9CNIYEI/w$p6dDBRvNOzRCdTEAO3O6Ug");
-- password: IP21admin
insert into user(userId,name, email, role, password) values(13, "INT491 User001", "int491.user001@mail.kmutt.ac.th", "admin", "$argon2id$v=19$m=65536,t=22,p=1$zAf+ZpDKCrm5FoknUaQHoQ$KC1zhvuPpJDXV5KcHLt43A");
-- password: IP21lecturer
insert into user(userId,name, email, role, password) values(14, "INT491 User002", "int491.user002@mail.kmutt.ac.th", "lecturer", "$argon2id$v=19$m=65536,t=22,p=1$/upVHoMbeNdheVDyBJPMYA$K1DP7e+wwtvRbPQmaRA6Vg");
-- password: IP21guest
insert into user(userId,name, email, role, password) values(15, "INT491 User004", "int491.user004@mail.kmutt.ac.th", "guest", "$argon2id$v=19$m=65536,t=22,p=1$Pq0izh3oj4irxtx4r/YccQ$4YH+aHcCLa3rTJeujjWRKw");
